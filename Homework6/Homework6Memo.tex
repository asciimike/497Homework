...
can be found in .../arch/arm/mm/Kconfig and look something like this:
\begin{verbatim}
 # ARMv7
config CPU_V7
...
definition we use occurs in KERNEL/.config, which looks like this:
...
the file KERNEL/arch/arm/kernel/head-common.S, which is included at the bottom
of KERNEL/arch/arm/kernel/head.S. This calls the start\_kernel() function in
main.c, which is located in KERNEL/init/main.c, located at line 473.
